...
void CADASTRAR()
{
  ...
  for (I = 0; I < 2; I++)
  {
    ...
    printf("Rua\n");
    fflush(stdin);
    gets(CONTATO[POSICAO].END[I].RUA);
    printf("Numero\n");
    fflush(stdin);
    scanf("%d", &CONTATO[POSICAO].END[I].NUM);
    printf("Cidade\n");
    fflush(stdin);
    gets(CONTATO[POSICAO].END[I].CIDADE);
    printf("Estado\n");
    fflush(stdin);
    gets(CONTATO[POSICAO].END[I].EST);
  }
  // CONT++;//
}
//-----------------------------
